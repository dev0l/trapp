...
struct TranscriptProgramView: View {
  ...
  private var transcriptTitle: String {
    appState.transcripts.first { $0.id == transcriptId }?.title ?? "Study Program"
  }
  ...
  private func generateShareText() -> String {
    var text = "\(transcriptTitle)\n"
    text += "Study Program: \(program.generatedAt.formatted(date: .abbreviated, time: .shortened))\n\n"
